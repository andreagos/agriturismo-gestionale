...
export default function DashboardFinanziaria() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      {/* KPI liquidità iniziale dal file Excel */}
      <div style={{ background: COLORS.surface, border: `1px solid ${COLORS.border}`, borderRadius: 8, padding: "16px 24px", display: "flex", alignItems: "center", gap: 24 }}>
        <div style={{ position: "relative" }}>
          <div style={{ position: "absolute", top: 0, left: 0, bottom: 0, width: 2, background: COLORS.gold, borderRadius: 2 }} />
          <div style={{ paddingLeft: 16 }}>
            <div style={{ fontSize: 11, color: COLORS.textMuted, letterSpacing: "0.1em", textTransform: "uppercase" }}>💰 Liquidità Iniziale (1 Aprile 2026)</div>
            <div style={{ fontSize: 28, fontWeight: 700, color: COLORS.gold, marginTop: 4 }}>€ 49.000</div>
            <div style={{ fontSize: 11, color: COLORS.textDim, marginTop: 2 }}>Dato reale da piano finanziario — punto di partenza della proiezione</div>
          </div>
        </div>
        <div style={{ marginLeft: "auto", display: "flex", flexDirection: "column", gap: 4, fontSize: 12, color: COLORS.textDim }}>
          <div>→ Fine Aprile: <span style={{ color: COLORS.gold }}>€ 35.010</span></div>
          <div>→ Agosto (min): <span style={{ color: COLORS.red }}>€ 4.596</span></div>
          <div>→ Fine Dicembre: <span style={{ color: COLORS.accent }}>€ 23.115</span></div>
        </div>
      </div>

      {/* Curva liquidità */}
      <div style={{ background: COLORS.surface, border: `1px solid ${COLORS.border}`, borderRadius: 8, padding: 24 }}>
        <div style={{ fontSize: 12, color: COLORS.textMuted, marginBottom: 4, letterSpacing: "0.08em", textTransform: "uppercase" }}>Liquidità Proiettata — Apr–Dic 2026</div>
        <div style={{ fontSize: 11, color: COLORS.textDim, marginBottom: 16 }}>Partenza: € 49.000 → proiezione mensile dal piano finanziario</div>
        <div style={{ display: "flex", gap: 0, alignItems: "flex-end" }}>
          {PIANO_2026.liquidita.map((liq, i) => {
            const maxL = PIANO_2026.liquiditaIniziale;
